...
#EXTENSIONS="http://svn.ez.no/svn/extensions/ezpaypal/trunk"
EXTENSIONS="$EXTENSIONS http://svn.ez.no/svn/extensions/eztinymce/trunk/ezoe/"
EXTENSIONS="$EXTENSIONS http://svn.ez.no/svn/extensions/ezodf/trunk/"

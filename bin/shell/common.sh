...
VERSION_ONLY="3.7"
VERSION_STATE=""
VERSION_PREVIOUS="3.7.0rc2"
VERSION_BRANCH="$VERSION_ONLY"
VERSION_NICK="$VERSION"
VERSION_STABLE="3.6.0"
DEVELOPMENT="false"
DEVELOPMENT_PREVIOUS="true"
[ -z "$VERSION_PREVIOUS" ] && VERSION_PREVIOUS="$VERSION_STABLE"
...
#REPOSITORY_BRANCH_PATH="URL: http://svn.ez.no/svn/nextgen/stable/3.7"
REPOSITORY_BRANCH_PATH="release/3.7.0"
...
VERSIONS="2.9 3.0 3.1 3.2 3.3 3.4 3.5 3.6"
STABLE_VERSIONS="3.0 3.1 3.2 3.3 3.4 3.5 3.6"

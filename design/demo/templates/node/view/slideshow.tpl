...
<tr>
	...
	{$Child:item.name|texttoimage('gallery')}
        ...
        <td align="right">{concat($view_parameters.offset|inc," of ",$list_count)|texttoimage('gallery')}</td>
</tr>
<tr> 
...
<tr bgcolor="#ffffff">
    ...
    <td width="6%"> <div align="center"><a href="javascript:OpenWindow({concat('layout/set/fullscreen/','content/view/slideshow/',$node.node_id,'/offset/',$view_parameters.offset)|ezurl(single)},'popup','scrollbars=no,resizable=yes,width=500,height=400')"><img src={"fullsize_icon.gif"|ezimage} width="18" height="18" alt="Fullscreen" border="0" /></a></div></td>
    ...
    <td width="41%"> <div align="right"><a href={concat('content/view','/thumbnail/',$node.node_id,$offset_of_page|gt(0)|choose('',concat('/offset/',$offset_of_page)))|ezurl}><img src={"x_close.gif"|ezimage} width="18" height="18" border="0"></a></div></td>
    {/let}
</tr>

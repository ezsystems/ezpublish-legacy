...
{if is_unset( $node_list )}
    ...
    {if $browse.start_node|gt( 1 )}
        ...
        <a href={concat( '/content/browse/', $main_node.parent_node_id, '/' )|ezurl}><img src={'up-16x16-grey.png'|ezimage} alt="{'Back'|i18n( 'design/admin/content/browse' )}" /></a>
    ...
    {else}
    <h2 class="context-title"><img src={'up-16x16-grey.png'|ezimage} alt="Back" /> {'folder'|class_icon( small, $current_node.class_name|wash )}&nbsp;{'Top level'|i18n( 'design/admin/content/browse' )}&nbsp;[{$current_node.children_count}]</h2>
    {/if}
    {/let}
{else}
 <h2 class="context-title"><img src={'up-16x16-grey.png'|ezimage} alt="Back" /> {'folder'|class_icon( small)}&nbsp;{'Search result'|i18n( 'design/admin/content/browse' )}&nbsp;[{$browse_list_count}]</h2>

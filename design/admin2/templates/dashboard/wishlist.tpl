...
{def $wish_list_items = fetch( 'shop', 'wish_list', hash( 'production_id', $wish_list.productcollection_id, 
...
<table class="list" cellpadding="0" cellspacing="0" border="0">
    ...
    {foreach $wish_list_items as $wish_list_item sequence array( 'bglight', 'bgdark' ) as $style}
        <tr class="{$style}">
            <td>

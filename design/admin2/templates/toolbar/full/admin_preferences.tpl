...
<ul>
    ...
    <li class="nobullet">{'View tab'|i18n( 'design/admin/parts/my/menu')}:
    {if ezpreference( 'admin_navigation_content' )}
        <span class="current">{'on'|i18n( 'design/admin/parts/my/menu' )}</span>&nbsp;|&nbsp;<a href={'/user/preferences/set/admin_navigation_content/0'|ezurl} title="{'Disable &quot;View tab&quot; while browsing content.'|i18n( 'design/admin/parts/my/menu' )}">{'off'|i18n( 'design/admin/parts/my/menu' )}</a>
    {else}
        <a href={'/user/preferences/set/admin_navigation_content/1'|ezurl} title="{'Enable &quot;View tab&quot; while browsing content.'|i18n( 'design/admin/parts/my/menu' )}">{'on'|i18n( 'design/admin/parts/my/menu' )}</a>&nbsp;|&nbsp;<span class="current">{'off'|i18n( 'design/admin/parts/my/menu' )}</span>
    {/if}
    </li>
</ul>
</div>

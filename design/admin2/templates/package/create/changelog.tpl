...
<div id="package" class="create">
    ...
    <div class="block">
        <label for="PackageChangelogPerson">{'Name'|i18n('design/admin/package')}</label>
        <input id="PackageChangelogPerson" class="box" type="text" name="PackageChangelogPerson" value="{$persistent_data.changelog_person|wash}" />
    </div>

    <div class="block">
        <label for="PackageChangelogEmail">{'Email'|i18n('design/admin/package')}</label>
        <input id="PackageChangelogEmail" class="box" type="text" name="PackageChangelogEmail" value="{$persistent_data.changelog_email|wash}" />
    </div>

    <div class="block">
        <label for="PackageChangelogText">{'Changes'|i18n('design/admin/package')}</label>
        ...
        <textarea id="PackageChangelogText" class="box" rows="10" name="PackageChangelogText">{$persistent_data.changelog_text|wash}</textarea>
    </div>

...
{cache-block keys=array( $module_result.uri, $user_hash, $admin_theme, first_set( $module_result.navigation_part, $navigation_part.identifier ) ) ignore_content_expiry}
...
{* Pr tab header cache *}
{cache-block keys=array( first_set( $module_result.navigation_part, $navigation_part.identifier ), $ui_context, $ui_component, $user_hash ) ignore_content_expiry}
...
{cache-block keys=array( $module_result.uri, $user_hash, $left_size_hash, first_set( $module_result.navigation_part, $navigation_part.identifier ) )}

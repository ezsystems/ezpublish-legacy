...
<div class="block">
    {if $product_class_list_valid}
        <div class="left">
            <select name="ProductClass" title="{'Select product class.'|i18n( 'design/admin/shop/productsoverview' )|wash()}">
    ...
    {else}
        <div class="left">
            {* Show button *}
            <input class="button-disabled" type="submit" name="ShowProductsButton" value="{'Show products'|i18n( 'design/admin/shop/productsoverview' )}" title="{'Show products of selected class.'|i18n( 'design/admin/shop/productsoverview' )}" disabled="disabled" />
        </div>
    {/if}

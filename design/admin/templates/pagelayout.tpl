...
<ul>
    ...
    {section show=ne( $ui_context, 'edit' )}
        ...
        {include uri='design:page_menuheadselected.tpl' menu_text='Content structure'|i18n( 'design/admin/pagelayout' ) tooltip='View the main content structure of the site'|i18n( 'design/admin/pagelayout' ) menu_url=concat( '/content/view/full/', ezini( 'NodeSettings', 'RootNode', 'content.ini' ) ) menu_item_order='selected-first'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='Content structure'|i18n( 'design/admin/pagelayout' ) tooltip='View the main content structure of the site'|i18n( 'design/admin/pagelayout' ) menu_url=concat( '/content/view/full/', ezini( 'NodeSettings', 'RootNode', 'content.ini' ) ) menu_item_order='first'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='Content structure'|i18n( 'design/admin/pagelayout' ) tooltip='View the main content structure of the site'|i18n( 'design/admin/pagelayout' ) menu_url=concat('/content/view/full/',ezini( 'NodeSettings', 'RootNode', 'content.ini' ) )  menu_item_order='first'}
    {/section}

    {* Media menu *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezmedianavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='Media library'|i18n( 'design/admin/pagelayout' ) tooltip='View archived files in the media library'|i18n( 'design/admin/pagelayout' ) menu_url=concat( '/content/view/full/', ezini( 'NodeSettings', 'MediaRootNode', 'content.ini' ) )  menu_item_order='selected-middle'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='Media library'|i18n( 'design/admin/pagelayout' ) tooltip='View archived files in the media library'|i18n( 'design/admin/pagelayout' ) menu_url=concat( '/content/view/full/', ezini( 'NodeSettings', 'MediaRootNode', 'content.ini' ) ) menu_item_order='middle'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='Media library'|i18n( 'design/admin/pagelayout' ) tooltip='View archived files in the media library'|i18n( 'design/admin/pagelayout' ) menu_url=concat( '/content/view/full/', ezini( 'NodeSettings', 'MediaRootNode', 'content.ini' ) ) menu_item_order='middle'}
    {/section}

    {* Users menu *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezusernavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='User accounts'|i18n( 'design/admin/pagelayout' ) tooltip='Manage users, user groups, and role settings and assignments'|i18n( 'design/admin/pagelayout' ) menu_url='/content/view/full/5/' menu_item_order='selected-middle'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='User accounts'|i18n( 'design/admin/pagelayout' ) tooltip='Manage users, user groups, and role settings and assignments'|i18n( 'design/admin/pagelayout' ) menu_url='/content/view/full/5/' menu_item_order='middle'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='User accounts'|i18n( 'design/admin/pagelayout' ) tooltip='Manage users, user groups, and role settings and assignments'|i18n( 'design/admin/pagelayout' ) menu_url='/content/view/full/5/' menu_item_order='middle'}
    {/section}

    {* Shop menu *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezshopnavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='Webshop'|i18n( 'design/admin/pagelayout' ) tooltip='Manage webshop customers, orders and settings'|i18n( 'design/admin/pagelayout' ) menu_url='/shop/orderlist/' menu_item_order='selected-middle'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='Webshop'|i18n( 'design/admin/pagelayout' ) tooltip='Manage webshop customers, orders and settings'|i18n( 'design/admin/pagelayout' ) menu_url='/shop/orderlist/' menu_item_order='middle'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='Webshop'|i18n( 'design/admin/pagelayout' ) tooltip='Manage webshop customers, orders and settings'|i18n( 'design/admin/pagelayout' ) menu_url='/shop/orderlist/' menu_item_order='middle'}
    {/section}

    {* Design menu *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezdesignnavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='Design'|i18n( 'design/admin/pagelayout' ) tooltip='Manage menus and toolbars of the user site'|i18n( 'design/admin/pagelayout' ) menu_url='/design/menuconfig' menu_item_order='selected-middle'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='Design'|i18n( 'design/admin/pagelayout' ) tooltip='Manage menus and toolbars of the user site'|i18n( 'design/admin/pagelayout' ) menu_url='/design/menuconfig' menu_item_order='middle'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='Design'|i18n( 'design/admin/pagelayout' ) tooltip='Manage menus and toolbars of the user site'|i18n( 'design/admin/pagelayout' ) menu_url='/design/menuconfig' menu_item_order='middle'}
    {/section}

    {* Set up menu *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezsetupnavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='Setup'|i18n( 'design/admin/pagelayout' ) tooltip='Manage advanced technical setting'|i18n( 'design/admin/pagelayout' ) menu_url='/setup/cache' menu_item_order='selected-middle'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='Setup'|i18n( 'design/admin/pagelayout' ) tooltip='Manage advanced technical setting'|i18n( 'design/admin/pagelayout' ) menu_url='/setup/cache' menu_item_order='middle'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='Setup'|i18n( 'design/admin/pagelayout' ) tooltip='Manage advanced technical setting'|i18n( 'design/admin/pagelayout' ) menu_url='/setup/cache' menu_item_order='middle'}
    {/section}

    {* Personal *}
    {section show=ne( $ui_context, 'edit' )}
        {section show=eq($navigation_part.identifier,'ezmynavigationpart')}
        {include uri='design:page_menuheadselected.tpl' menu_text='My account'|i18n( 'design/admin/pagelayout' ) tooltip='Manage your personal settings, bookmarks and drafts'|i18n( 'design/admin/pagelayout' ) menu_url='/content/draft/' menu_item_order='selected-last'}
        {section-else}
        {include uri='design:page_menuheadenabled.tpl' menu_text='My account'|i18n( 'design/admin/pagelayout' ) tooltip='Manage your personal settings, bookmarks and drafts'|i18n( 'design/admin/pagelayout' ) menu_url='/content/draft/' menu_item_order='last'}
        {/section}
    {section-else}
        {include uri='design:page_menuheadgray.tpl' menu_text='My account'|i18n( 'design/admin/pagelayout' ) tooltip='Manage your personal settings, bookmarks and drafts'|i18n( 'design/admin/pagelayout' ) menu_url='/content/draft/' menu_item_order='last'}
    {/section}

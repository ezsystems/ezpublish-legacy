...
<input class="button" type="submit" name="EditLanguageButton" value="{'Edit'|i18n( 'design/admin/content/edit' )}" title="{'Edit the selected translation of the draft that is being edit.'|i18n( 'design/admin/content/edit' )}" />
<input class="button" type="submit" name="TranslateLanguageButton" value="{'Translate'|i18n( 'design/admin/content/edit' )}" title="{'Edit the selected translation of the draft using the currently displayed content as a reference.'|i18n( 'design/admin/content/edit' )}" />
{section-else}

...
<tr class="{$seq}">
	...
	{/foreach}
        ...
        {else}
			<input type="image" src={'copy_disabled.png'|ezimage} name="" value="" disabled="disabled" title="{'You can not make copies of versions because you do not have permissions to edit the object.'|i18n( 'design/admin/content/history' )}" />
        {/if}
	{undef $can_edit_lang}
    </td>

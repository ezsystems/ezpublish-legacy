...
<h1 class="context-title">{'Versions for <%object_name> [%version_count]'|i18n( 'design/admin/content/history',, hash( '%object_name', $object.name, '%version_count', $version_list|count ) )|wash}</h1>
...
<tr class="{$seq}">
	...
	{/foreach}
        ...
        {else}
			<input type="image" src={'copy-disabled.png'|ezimage} name="" value="" disabled="disabled" title="{'You can not make copies of versions because you do not have permissions to edit the object.'|i18n( 'design/admin/content/history' )}" />
        {/if}
	{undef $can_edit_lang}
    </td>

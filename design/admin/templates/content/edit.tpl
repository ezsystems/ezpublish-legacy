...
<div class="block">
    ...
    <input class="button" type="submit" name="DiscardButton" value="{'Discard draft'|i18n( 'design/admin/content/edit' )}" onclick="return confirmDiscard( '{'Are you sure you want to discard the changes?'|i18n( 'design/admin/content/edit' )}' );" title="{'Discard the draft that is being edited. This will also get rid of the translations that belong to the draft (if any).'|i18n( 'design/admin/content/edit' ) }" />

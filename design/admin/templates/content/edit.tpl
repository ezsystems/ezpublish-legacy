...
<div class="block">
    ...
    <input class="button" type="submit" name="DiscardButton" value="{'Discard draft'|i18n( 'design/admin/content/edit' )}" onclick="return confirmDiscard( '{**REMOVE**}{'Are you sure you want to discard the draft?'|i18n( 'design/admin/content/edit' )|wash(javascript)}{**/REMOVE**}{**ADD**}{escape_javascript(i18n('Are you sure you want to discard the draft?', 'design/admin/content/edit' ))}{**/ADD**}' );" title="{'Discard the draft that is being edited. This will also remove the translations that belong to the draft (if any).'|i18n( 'design/admin/content/edit' ) }" />

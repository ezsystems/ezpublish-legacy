...
<td>
<input class="button" type="submit" name="NewURLAliasButton" value="{'Add'|i18n( 'design/admin/content/urltranslator' )}" title="{'Use this button to add a new system URL forwarding. System URL forwarding is used to forward any URL to a system URL in eZ publish.'|i18n( 'design/admin/content/urltranslator' )}" />
</td>
</tr>
</table>
...
<td>
<input class="button" type="submit" name="NewForwardURLAliasButton" value="{'Add'|i18n( 'design/admin/content/urltranslator' )}" title="{'Use this button to add a new virtual URL forwarding. Virtual URL forwarding is used to forward any URL to an existing virtual URL in eZ publish.'|i18n( 'design/admin/content/urltranslator' )}" />
</td>
</tr>
</table>
{* DESIGN: Content END *}</div></div></div></div></div></div>
...
<td>
<input class="button" type="submit" name="NewWildcardURLAliasButton" value="{'Add'|i18n( 'design/admin/content/urltranslator' )}" title="{'Use this button to add a new virtual URL forwarding with wildcard match. Virtual URL forwarding is used to forward any URL to an existing virtual URL in eZ publish. The wildcard match is useful if you have moved a complete tree from one place to another.'|i18n( 'design/admin/content/urltranslator' )}" />
</td>
</tr>
</table>
{* DESIGN: Content END *}</div></div></div></div></div></div>

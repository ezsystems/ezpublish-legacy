...
<h2 class="context-title">{'Relations'|i18n( 'design/admin/navigation/relations')}</h2>

{* Show related objects *}
<table class="list" cellspacing="0">
<tr>
    <th>{'Related objects'|i18n( 'design/admin/navigation/relations' )} ({$node.object.related_contentobject_count})</th>
</tr>
...
<table class="list" cellspacing="0">
<tr>
    <th>{'Reverse related objects'|i18n( 'design/admin/navigation/relations' )} ({$node.object.reverse_related_contentobject_count})</th>
</tr>

...
<div class="block">
<p>{'Use the radio buttons to choose a user and click "OK". The user will become the owner of the objects that were imported using RSS.'|i18n( 'design/admin/rss/browse_user' )}</p>

...
<tr>
    ...
    <p class="menuitem">
    {"Content"|i18n("design/admin/layout")}
    </p>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td class="menu" width="99%">
    <p class="menuitem"><a class="menuitem" href={"/user/password/14/"|ezurl}>{"Change password"|i18n("design/admin/layout")}</a></p>
    </td>
</tr>
</table>
{/section}
...
<tr>
    ...
    <td class="menu" width="99%">
    <p class="menuitem">
    {"Users"|i18n("design/admin/layout")}
    </p>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td class="menu" width="99%">
    <p class="menuitem">
    {"Set up"|i18n("design/admin/layout")}
    </p>
    </td>
</tr>
<tr>

...
<div class="block">
<input class="button" type="submit" name="EditButton" value="{'Edit'|i18n( 'design/admin/workflow/view' )}">
<input class="button" type="submit" name="DeleteButton" value="{'Remove'|i18n( 'design/admin/workflow/view' )}">
</div>

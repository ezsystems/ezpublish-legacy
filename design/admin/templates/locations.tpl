...
{section show=$node.can_edit}
    ...
    <input class="button" type="submit" name="AddAssignmentButton" value="{'Add new'|i18n( 'design/admin/node/view/full' )}" title="{'Add new location(s).'|i18n( 'design/admin/node/view/full' )}" />
{section-else}
    ...
    <input class="button" type="submit" name="" value="{'Add new'|i18n( 'design/admin/node/view/full' )}" title={'You can not add new locations because you do not have permissions to edit the current item.'|i18n( 'design/admin/node/view/full' )} disabled="disabled" />
{/section}
</div>

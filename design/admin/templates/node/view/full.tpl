...
<h2 class="context-title"><a href="#" onclick="ezpopmnu_showTopLevel( 'ClassMenu', '' , '' , ''); return false;">{$node.class_identifier|class_icon( normal, $node.class_name )}</a> {$node.name} [{$node.class_name}]</h2>

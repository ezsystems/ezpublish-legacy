...
<h2 class="context-title">{"Class &lt;%1"|i18n("design/standard/class/edit",,array( $class.name|wash) )}&gt;</h2>

<div class="byline">
<p>{"Last modified by %username on %time"|i18n("design/standard/class/edit",,
...
<div class="block">
    <label>{"Container:"|i18n("design/standard/class/edit")}:</label>
...
<div class="block">
    <label>{"Object count"|i18n("design/standard/class/edit")}:</label>

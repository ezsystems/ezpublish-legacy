...
<h2>{'The requested page could not be displayed. (20)'|i18n( 'design/admin/error/kernel' )}</h2>
...
<ul>
    <li>{'The address was misspelled. Try changing the URL.'|i18n( 'design/standard/error/kernel' )}</li>
    <li>{'The name of the module was misspelled. Try changing the URL.'|i18n( 'design/standard/error/kernel' )}</li>

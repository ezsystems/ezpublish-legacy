...
{case in=array(2,3)}
  {if $collab_item.is_creator}
    ...
    {if $content_version|null()|not()}
      ...
      <p><a href={concat( "content/edit/", $content_version.contentobject_id, '/f/', $content_version.initial_language.locale )|ezurl}>{"Edit the object"|i18n('design/admin/collaboration/handler/view/full/ezapprove')}</a></p>
    {/if}
  {else}
    {if and( is_set( $contentobject_link ),$contentobject_link )}

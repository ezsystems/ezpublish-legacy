...
{section var=Roles loop=$roles sequence=array( bglight, bgdark )}
    ...
    <td><a href={concat( '/role/edit/', $Roles.item.id)|ezurl}><img src={'edit.gif'|ezimage} alt="{'Edit'|i18n( 'design/admin/role/list' )}" title="{'Edit the <%role_name> role.'|i18n( 'design/admin/role/list',, hash( '%role_name', $Roles.item.name  ) )|wash}" /></a></td>
    </tr>
{/let}
{/section}
</table>

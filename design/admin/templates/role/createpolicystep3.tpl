...
<h2>{'Step two: select function [completed]'|i18n( 'design/admin/role/createpolicy' )}</h2>

<div class="block">
<label>{'Selected function'|i18n( 'design/admin/role/createpolicy' )}</label>
...
<h2>{'Step three: set function limitations'|i18n( 'design/admin/role/createpolicy' )}</h2>

<p>
{'Instructions:'|i18n( 'design/admin/role/createpolicy' )}
<ol>
<li>{'Set the desired function limitations using the controls below.'|i18n( 'design/admin/role/createpolicy' )}</li>
<li>{'Click the "OK" button to finish the wizard. The policy will be added to the role that is currently being edited.'|i18n( 'design/admin/role/createpolicy' )}</li>
</ol>
</p>
...
{case match=-1} selected="selected"{/case}{case}{/case}{/switch}>{'Any'|i18n( 'design/admin/role/createpolicy' )}</option>
...
{case match="Node"}
<div class="block">
<label>{'Nodes [%node_count]'|i18n( 'design/admin/role/createpolicy',, hash( '%node_count', $node_list|count ) )}</label>
{section show=$node_list}
<table class="list" cellspacing="0">
<tr>
<th class="tight">&nbsp;</th>
<th>{'Name'|i18n( 'design/admin/role/createpolicy' )}</th>
</tr>
...
{section-else}
<p>
{'The node list is empty.'|i18n( 'design/admin/role/createpolicy' )}
</p>
{/section}
<input class="button" type="submit" name="DeleteNodeButton" value="{'Remove selected'|i18n( 'design/admin/role/createpolicy' )}" {section show=$node_list|not}disabled="disabled"{/section} />
<input class="button" type="submit" name="BrowseLimitationNodeButton" value="{'Add nodes'|i18n( 'design/admin/role/createpolicy' )}" />
</div>
{/case}
...
{case match="Subtree"}
<div class="block">
<label>{'Subtrees [%subtree_count]'|i18n( 'design/admin/role/createpolicy',, hash( '%subtree_count', $subtree_list|count ) )}</label>
{section show=$subtree_list}
<table class="list" cellspacing="0">
<tr>
<th class="tight">&nbsp;</th>
<th>{'Subtree'|i18n( 'design/admin/role/createpolicy' )}</th>
</tr>
...
{section-else}
<p>{'The subtree list is empty.'|i18n( 'design/admin/role/createpolicy' )}</p>
{/section}
<input class="button" type="submit" name="DeleteSubtreeButton" value="{'Remove selected'|i18n( 'design/admin/role/createpolicy' )}" {section show=$subtree_list|not}disabled="disabled"{/section} />
<input class="button" type="submit" name="BrowseLimitationSubtreeButton" value="{'Add subtrees'|i18n( 'design/admin/role/createpolicy' )}" />
</div>
{/case}
...
<input class="button" type="submit" name="Step2" value="{'Go back to step two'|i18n( 'design/admin/role/createpolicy' )}" />
</div>
...
<input class="button" type="submit" name="AddLimitation" value="{'OK'|i18n( 'design/admin/role/createpolicy' )}" />
<input class="button" type="submit" name="Cancel" value="{'Cancel'|i18n( 'design/admin/role/createpolicy' )}" />
</div>

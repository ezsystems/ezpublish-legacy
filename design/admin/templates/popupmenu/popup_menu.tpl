...
<div class="popupmenu" id="ContextMenu">
    ...
    <a id="menu-advanced" href="#" onmouseover="ezpopmenu_showSubLevel( event, 'Advanced', 'menu-advanced' ); return false;">{'Advanced'|i18n('design/admin/popmenu')}</a>
    <hr />
...
<div class="popupmenu" id="SubitemsContextMenu">
    ...
    <a id="child-menu-advanced" href="#" onmouseover="ezpopmenu_showSubLevel( event, 'Advanced', 'child-menu-advanced' ); return false;">{'Advanced'|i18n('design/admin/popmenu')}</a>
    <hr />

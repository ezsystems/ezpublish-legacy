...
<div class="popupmenu" id="ContextMenu">
    ...
    <hr />
    <a id="menu-remove" href="#" onmouseover="ezpopmnu_mouseOver( 'ContextMenu' )" onclick="ezpopmnu_submitForm( 'menu-form-remove' ); return false;">{"Remove"|i18n("design/standard/popupmenu")}</a>
    ...
    <hr />
    <a id="menu-bookmark" href="#" onmouseover="ezpopmnu_mouseOver( 'ContextMenu' )" onclick="ezpopmnu_submitForm( 'menu-form-bookmark' ); return false;">{"Add to my bookmarks"|i18n("design/standard/popupmenu")}</a>

...
<ul>
    ...
    {section show=ezpreference( 'admin_edit_show_locations' )}
        <b>{'on'|i18n( 'design/admin/parts/my/menu' )}</b>&nbsp;<a href={'/user/preferences/set/admin_edit_show_locations/0'|ezurl} title="{'Disable location window when editing content.'|i18n( 'design/admin/node/view/full' )}">{'off'|i18n( 'design/admin/parts/my/menu' )}</a>
    {section-else}
        <a href={'/user/preferences/set/admin_edit_show_locations/1'|ezurl} title="{'Enable location window when editing content.'|i18n( 'design/admin/node/view/full' )}">{'on'|i18n( 'design/admin/parts/my/menu' )}</a>&nbsp;<b>{'off'|i18n( 'design/admin/parts/my/menu' )}</b>
    {/section}
    </li>
</ul>

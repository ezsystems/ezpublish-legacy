...
{case match='medium'}
<a href={concat( '/user/preferences/set/admin_left_menu_width/small/', $uri_string )|ezurl} title="{'Change the left menu width to small size.'|i18n( 'design/admin/parts/media/menu' )}">{'Small'|i18n( 'design/admin/parts/media/menu' )}</a>
<span class="current">{'Medium'|i18n( 'design/admin/parts/media/menu' )}</span>
<a href={concat( '/user/preferences/set/admin_left_menu_width/large/', $uri_string )|ezurl} title="{'Change the left menu width to large size.'|i18n( 'design/admin/parts/media/menu' )}">{'Large'|i18n( 'design/admin/parts/media/menu' )}</a>
{/case}

{case match='large'}
<a href={concat( '/user/preferences/set/admin_left_menu_width/small/', $uri_string )|ezurl} title="{'Change the left menu width to small size.'|i18n( 'design/admin/parts/media/menu' )}">{'Small'|i18n( 'design/admin/parts/media/menu' )}</a>
<a href={concat( '/user/preferences/set/admin_left_menu_width/medium/', $uri_string )|ezurl} title="{'Change the left menu width to medium size.'|i18n( 'design/admin/parts/media/menu' )}">{'Medium'|i18n( 'design/admin/parts/media/menu' )}</a>

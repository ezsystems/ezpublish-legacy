...
<a class="leftmenuitem" href={concat("/content/view/full/",ezini('NodeSettings','MediaRootNode','content.ini'))|ezurl}>{"Frontpage"|i18n("design/admin/layout")}</a>
</div>

<div style="width: 100%; padding-right: 4px; padding-left: 15px; padding-top: 4px; padding-bottom: 4px; margin-bottom:1px; background-image:url('{"bgtiledark.gif"|ezimage(no)}'); background-repeat: repeat;">
<a class="leftmenuitem" href={concat("/content/view/sitemap/",ezini('NodeSettings','MediaRootNode','content.ini'))|ezurl}>{"Sitemap"|i18n("design/admin/layout")}</a>
</div>

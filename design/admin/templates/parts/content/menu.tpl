...
<h4><a class="showhide" href={'/user/preferences/set/admin_treemenu/0'|ezurl}><span class="bracket">[</span>-<span class="bracket">]</span></a> {'Content structure'|i18n( 'design/admin/parts/content/menu' )}</h4>
...
<h4><a class="showhide" href={'/user/preferences/set/admin_treemenu/1'|ezurl}><span class="bracket">[</span>+<span class="bracket">]</span></a> {'Content structure'|i18n( 'design/admin/parts/content/menu' )}</h4>

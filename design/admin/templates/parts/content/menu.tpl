...
{section show=eq(ezpreference('bookmark_menu'),'on')}
 <a href={"/user/preferences/set/bookmark_menu/off"|ezurl}><img src={"up.gif"|ezimage} width="11" height="6" /></a>
</div>
<ul class="leftmenu">
...
{section-else}
 <a href={"/user/preferences/set/bookmark_menu/on"|ezurl}><img src={"down.gif"|ezimage} width="11" height="6" /></a>
</div>
{/section}
...
{section show=eq(ezpreference('history_menu'),'on')}
 <a href={"/user/preferences/set/history_menu/off"|ezurl}><img src={"up.gif"|ezimage} width="11" height="6" /></a>
</div>
<ul class="leftmenu">
...
{section-else}
 <a href={"/user/preferences/set/history_menu/on"|ezurl}><img src={"down.gif"|ezimage} width="11" height="6" /></a>
</div>
{/section}

...
<tr class="{$sequence}">
    <td><img src="{$language.locale|flag_icon}" width="18" height="12" alt="{$language.locale|wash}" />&nbsp;<a href={concat( '/state/view/', $group.identifier,'/',$state.identifier , '/', $language.locale )|ezurl} title="{'View translation.'|i18n( 'design/admin/node/view/full' )}">{$language.name|wash}</td>

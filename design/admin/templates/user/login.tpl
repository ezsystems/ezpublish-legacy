...
<div class="block">
    <p>{'Please enter a valid user name/password combination and click "Log in".'|i18n( 'design/admin/user/login' )}</p>
    <p>{'Use the "Register" button to create a new account.'|i18n( 'design/admin/user/login' )}</p>
</div>

<div class="block">
    <label for="id1">{'User name'|i18n( 'design/admin/user/login' )}</label>
    <input class="halfbox" type="text" size="10" name="Login" id="id1" value="{$User:login}" tabindex="1" title="{'Enter a valid user name into this field.'|i18n( 'design/admin/user/login' )}" />
</div>
...
<div class="block">
    <input class="button" type="submit" name="LoginButton" value="{'Log in'|i18n( 'design/admin/user/login', 'Login button' )}" tabindex="1" title="{'Click here to log in using the user name/password combination entered in the fields above.'|i18n( 'design/admin/user/login' )}" />

...
<h1 class="context-title">{'Uninstall package'|i18n('design/standard/package')}</h1>
...
{* DESIGN: Control bar START *}<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-tc"><div class="box-bl"><div class="box-br">
    <div class="block">
	<input class="button" type="submit" name="UninstallPackageButton" value="{'Uninstall package'|i18n('design/standard/package')}" />

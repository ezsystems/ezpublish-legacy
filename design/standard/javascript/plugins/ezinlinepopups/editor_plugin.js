...
(function() {
	...
	tinymce.create('tinymce.plugins.eZInlinePopups', {
		init : function(ed, url) {
			// Replace window manager
            var s = ed.settings;
			ed.onBeforeRenderUI.add(function() {
				ed.windowManager = new tinymce.InlineWindowManager(ed);
				DOM.loadCSS(s.ez_js_url + '/plugins/ezinlinepopups/skins/' + (ed.settings.inlinepopups_skin || 'clearlooks2') + "/window.css");
			});
		},

		getInfo : function() {
			return {
				longname : 'eZInlinePopups',
...
//			cp = DOM.getPos(t.editor.getContainer());
	...
	// Register plugin
	tinymce.PluginManager.add('ezinlinepopups', tinymce.plugins.eZInlinePopups);
})();

...
<td class="element">
    <label>{$Limitations:item.name}</label><div class="labelbreak"/>
     ...
     {if $current_limitation_list[$Limitations:item.name]|contains($Limitations:LimitationValues:item.value)} selected="selected" {/if}>{$Limitations:LimitationValues:item.Name}</option>
     {/section}   
     </select>
</td>
     {/section}  

...
<select name="{$id_name}" title="{'Use this menu to select the type of attribute you wish to create. Click the "add attribute" button. The attribute will be appended to the bottom of the list of attributes.'|i18n( 'design/standard/class/edit' )|wash}">

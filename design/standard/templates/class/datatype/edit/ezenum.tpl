...
<input class="button" type="submit" name="CustomActionButton[{$class_attribute.id}_new_enumelement]" value="{'New Enum Element'|i18n('class/datatype')}" />
<input class="button" type="submit" name="CustomActionButton[{$class_attribute.id}_remove_selected]" value="{'Remove Selected'|i18n('class/datatype')}" />
</div>

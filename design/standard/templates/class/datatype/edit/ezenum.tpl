...
Enum Element <input type="text" name = "ContentClass_data_enumelement_{$class_attribute.id}[]" value="{$EnumList:item.enumelement}" size="10" maxlength="20">
&nbsp;&nbsp;Enum Value <input type="text" name = "ContentClass_data_enumvalue_{$class_attribute.id}[]" value="{$EnumList:item.enumvalue}" size="10" maxlength="20">

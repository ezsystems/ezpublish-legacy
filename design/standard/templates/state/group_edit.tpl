...
<div class="block">
<div class="element">
<label>{"Identifier:"|i18n('design/standard/state/group_edit')}</label>
...
<div class="element">
<label>{"Default language:"|i18n('design/standard/state/group_edit')}</label>
...
{let $translations=$group.all_translations
    ...
    {/if}
    <label>{"Name:"|i18n('design/standard/state/group_edit')}</label>
    <input type="text" size="80" maxlength="45" name="ContentObjectStateGroup_name[]" value="{$translation.name|wash}" />
    <label>{"Description:"|i18n('design/standard/state/group_edit')}</label>

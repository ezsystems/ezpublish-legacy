...
<tr>
    ...
    <td class="{$RSSExport:sequence}" width="1"><div class="listbutton"><a href={concat("rss/edit_export/",$RSSExport:item.id)|ezurl}><img class="button" src={"edit.png"|ezimage} width="16" height="16" alt="Edit" /></a></div></td>
...
<tr>
    ...
    <td class="{$RSSImport:sequence}" width="1"><div class="listbutton"><a href={concat("rss/edit_import/",$RSSImport:item.id)|ezurl}><img class="button" src={"edit.png"|ezimage} width="16" height="16" alt="Edit" /></a></div></td>

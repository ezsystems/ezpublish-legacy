...
<input class="button" type="submit" name="CustomActionButton[{$event.id}_new_classelement]" value="{'New Entry'|i18n('design/standard/workflow/eventtype')}" />
<input class="button" type="submit" name="CustomActionButton[{$event.id}_remove_selected]" value="{'Remove Selected'|i18n('design/standard/workflow/eventtype')}" />
<input class="button" type="submit" name="CustomActionButton[{$event.id}_load_class_attribute_list]" value="{'Load Attributes'|i18n('design/standard/workflow/eventtype')}" />
</div>

...
<div class="element">
 {let selectedUsers=$event.approve_groups}
    <label>{"Editor groups"|i18n("design/standard/workflow/eventtype/edit")}</label><div class="labelbreak"></div>
...
<option value="">{"None"|i18n("design/standard/workflow/eventtype/edit")}</option>
     ...
     {section name=Users loop=$event.workflow_type.usergroups}

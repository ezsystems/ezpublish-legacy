        ...
        <div class="panel">
            <table class="properties">
                ...
                <tr>
                    ...
                    <td colspan="2"><input name="fileName" type="file" id="fileName" size="50" accept="image/*" value="" title="{'Choose file to upload from your local machine.'|i18n('design/standard/ezoe/wai')}" /></td>
                </tr>

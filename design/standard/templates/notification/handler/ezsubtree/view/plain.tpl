...
{set-block scope=root variable=subject}{$object.content_class.name} "{$object.name}" was updated [{ezini("SiteSettings","SiteURL")} - {$object.main_node.parent.name}]{/set-block}
...
{section-else}
{set-block scope=root variable=subject}{$object.content_class.name} "{$object.name}" was published [{ezini("SiteSettings","SiteURL")} - {$object.main_node.parent.name}]{/set-block}

...
<label>{"Old Password"|i18n("user")}:</label><div class="labelbreak"></div>
...
<label>{"New Password"|i18n("user")}:</label><div class="labelbreak"></div>
<input class="halfbox" type="password" name="newPassword" size="11" value="{$newPassword}" />
</div>
<div class="element">
{section show=$newPasswordNotMatch}*{/section}
<label>{"Retype Password"|i18n("user")}:</label><div class="labelbreak"></div>
...
<input class="button" type="submit" name="OKButton" value="OK" />

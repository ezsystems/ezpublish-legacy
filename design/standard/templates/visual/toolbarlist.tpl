...
<h1 class="context-title">{'Toolbar management'|i18n( 'design/standard/visual/toolbar' )}</h1>
...
<h2 class="context-title">{'Available toolbars for the <%siteaccess> siteaccess'|i18n( 'design/standard/visual/toolbar',, hash( '%siteaccess', $current_siteaccess ) )|wash}</h2>

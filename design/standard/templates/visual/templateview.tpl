...
<h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'The overrides could not be removed.'|i18n( 'design/standard/visual/templateview' )}</h2>

{section show=$not_removed}
<p>{'The following files and override rules could not be removed because of insufficient file permissions'|i18n( 'design/standard/visual/templateview' )}:</p>
<ul>
...
<h1 class="context-title">{'Overrides for <%template_name> template in <%current_siteaccess> siteaccess [%override_count]'|i18n( 'design/standard/visual/templateview',, hash( '%template_name', $template_settings.template, '%current_siteaccess', $current_siteaccess, '%override_count', $template_settings.custom_match|count ) )|wash}</h1>
...
<div class="block">
<label>{'Siteaccess'|i18n( 'design/standard/visual/templateview' )}:</label>
...
<input class="button" type="submit" name="SelectCurrentSiteAccessButton" value="{'Set'|i18n( 'design/standard/visual/templateview' )}" />
</div>
...
<tr>
    <th class="tight"><img src={'toggle-button-16x16.gif'|ezimage} alt="{'Invert selection.'|i18n( 'design/standard/visual/templateview' )}" title="{'Invert selection.'|i18n( 'design/standard/visual/templateview' )}" onclick="ezjs_toggleCheckboxes( document.templateview, 'RemoveOverrideArray[]' ); return false;" /></th>
    <th>{'Name'|i18n( 'design/standard/visual/templateview' )}</th>
    <th>{'File'|i18n( 'design/standard/visual/templateview' )}</th>
    <th>{'Match conditions'|i18n( 'design/standard/visual/templateview' )}</th>
    <th class="tight">{'Priority'|i18n( 'design/standard/visual/templateview' )}</th>
    <th class="tight">&nbsp;</th>
</tr>

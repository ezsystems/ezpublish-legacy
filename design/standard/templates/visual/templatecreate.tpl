...
<h2>{'Could not create template, permission denied.'|i18n( 'design/standard/visual/templatecreate' )}</h2>
</div>
{/if}
...
<h1 class="context-title">{'Create new template override for <%template_name>'|i18n( 'design/standard/visual/templatecreate',, hash( '%template_name', $template ) )|wash}</h1>
...
<p>{'The newly created template file will be placed in'|i18n( 'design/standard/visual/templatecreate' )} design/{$site_design}/override/templates/.</p>
...
<div class="block">
    <label>{'Filename'|i18n( 'design/standard/visual/templatecreate' )}:</label>
...
<div class="block">
<label>{'Override keys'|i18n( 'design/standard/visual/templatecreate' )}:</label>

<table>
<tr>
    <td>{'Class'|i18n( 'design/standard/visual/templatecreate' )}:</td>
    <td>
...
<tr>
    <td>{'Section'|i18n( 'design/standard/visual/templatecreate' )}:</td>
    <td>
    <select name="Match[section]">
        <option value="-1">{'All sections'|i18n( 'design/standard/visual/templatecreate' )}</option>
...
<h2>{'Override keys'|i18n( 'design/standard/visual/templatecreate' )}</h2>
</div>
...
<tr>
    <td>
    <p>
    {'Class'|i18n( 'design/standard/visual/templatecreate' )}
    </p>
    </td>
    <td>
    <select name="Match[class_identifier]">
...
<tr>
    <td>
    <p>
    {'Section'|i18n( 'design/standard/visual/templatecreate' )}
    </p>
    </td>
    <td>
    <select name="Match[section]">
...
<tr>
    <td>
    <p>
    {'Object'|i18n( 'design/standard/visual/templatecreate' )}
    </p>
    </td>
    <td>
...
<div class="objectheader">
<h2>{'Base template on'|i18n( 'design/standard/visual/templatecreate' )}</h2>
</div>
<div class="object">
...
{* DESIGN: Control bar START *}<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-tc"><div class="box-bl"><div class="box-br">
    <div class="block">
        <input class="button" type="submit" name="CreateOverrideButton" value="{'OK'|i18n( 'design/standard/visual/templatecreate' )}" />
        <input class="button" type="submit" name="CancelOverrideButton" value="{'Cancel'|i18n( 'design/standard/visual/templatecreate' )}" />
    </div>

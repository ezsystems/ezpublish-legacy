...
<h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'Version not a draft'|i18n( 'design/standard/content/history' )}</h2>
<ul>
    ...
    <li>{'To edit this version create a copy of it.'|i18n( 'design/standard/content/history' )}</li>
</ul>
</div>
{/case}
{case match=2}
<div class="message-warning">
<h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'Version not yours'|i18n( 'design/standard/content/history' )}</h2>
<ul>
    <li>{'Version %1 was not created by you, only your own drafts can be edited.'|i18n( 'design/standard/content/history',, array( $edit_version ) )}</li>
    <li>{'To edit this version create a copy of it.'|i18n( 'design/standard/content/history' )}</li>
</ul>
</div>
{/case}
{case match=3}
<div class="message-warning">
<h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'Unable to create new version'|i18n( 'design/standard/content/history' )}</h2>
<ul>
...
<h1 class="context-title">{'Versions for <%object_name> [%version_count]'|i18n( 'design/standard/content/history',, hash( '%object_name', $object.name, '%version_count', $version_list|count ) )|wash}</h1>
...
<tr class="{$seq}">
	...
	<td>
	    ...
	    {else}
            <input type="checkbox" name="" value="" disabled="disabled" title="{'Version #%version_number can not be removed because it is either the published version of the object or because you do not have permissions to remove it.'|i18n( 'design/standard/content/history',, hash( '%version_number', $version.version ) )}" />
        {/if}
    </td>
...
<div class="block">
<div class="left">
<input class="button" type="submit" name="RemoveButton" value="{'Remove selected'|i18n( 'design/standard/content/history' )}" title="{'Remove the selected versions from the object.'|i18n( 'design/standard/content/history' )}" />
...
<form action={concat( $module.functions.history.uri, '/', $object.id, '/' )|ezurl} method="post">
    ...
    <input class="button" type="submit" name="DiffButton" value="{'Show differences'|i18n( 'design/standard/content/history' )}" />
</form>
</div>
{/if}
...
<div class="context-block">
{* DESIGN: Header START *}<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">
<h2 class="context-title">{'Published version'|i18n( 'design/standard/content/history' )}</h2>
...
<div class="context-block">
{* DESIGN: Header START *}<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">
<h2 class="context-title">{'New drafts [%newerDraftCount]'|i18n( 'design/standard/content/history',, hash( '%newerDraftCount', $newerDraftVersionListCount ) )}</h2>
{* DESIGN: Subline *}<div class="header-subline"></div>
{* DESIGN: Header END *}</div></div></div></div></div></div>
{* DESIGN: Content START *}<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-bl"><div class="box-br"><div class="box-content">
...
{/literal}
{* DESIGN: Header START *}<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">
<h2 class="context-title">{'Differences between versions %oldVersion and %newVersion'|i18n( 'design/standard/content/history',, hash( '%oldVersion', $oldVersion, '%newVersion', $newVersion ) )}</h2>
...
<input class="button" type="submit" value="{'Back to history'|i18n( 'design/standard/content/history' )}" />
</form>
</div>
</div>
{/if}

...
<h1 class="context-title">{'Versions for <%object_name> [%version_count]'|i18n( 'design/standard/content/diff',, hash( '%object_name', $object.name, '%version_count', $list_count ) )|wash}</h1>

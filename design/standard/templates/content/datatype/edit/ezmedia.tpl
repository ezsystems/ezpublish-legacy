...
<div class="element">
<input type="checkbox" name="ContentObjectAttribute_data_media_is_autoplay_{$attribute.id}" value="{$attribute.content.is_autoplay}" {section show=$attribute.content.is_autoplay}checked{/section} />&nbsp;<label class="check">{"Autoplay"|i18n("design/standard/content/datatype")}</label><div class="labelbreak"></div>
<input type="checkbox" name="ContentObjectAttribute_data_media_is_loop_{$attribute.id}" value="{$attribute.content.is_loop}" {section show=$attribute.content.is_loop}checked{/section} />&nbsp;<label class="check">{"Loop"|i18n("design/standard/content/datatype")}</label><div class="labelbreak"></div>
</div>
<div class="break"></div>
</div>
...
<input type="checkbox" name="ContentObjectAttribute_data_media_has_controller_{$attribute.id}" value="{$attribute.content.has_controller}" {section show=$attribute.content.has_controller}checked{/section} />&nbsp;<label class="check">{"Controller"|i18n("design/standard/content/datatype")}</label><div class="labelbreak"></div>

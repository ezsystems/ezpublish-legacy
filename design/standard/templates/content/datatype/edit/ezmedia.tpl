...
<div class="element">
<input type="checkbox" name="ContentObjectAttribute_data_media_is_autoplay_{$attribute.id}" value="{$attribute.content.is_autoplay}" {section show=$attribute.content.is_autoplay}checked{/section} />&nbsp;<label class="check">{"Autoplay"|i18n("content/datatypes/ezmedia")}</label><div class="labelbreak"></div>
<input type="checkbox" name="ContentObjectAttribute_data_media_is_loop_{$attribute.id}" value="{$attribute.content.is_loop}" {section show=$attribute.content.is_loop}checked{/section} />&nbsp;<label class="check">{"Loop"|i18n("content/datatypes/ezmedia")}</label><div class="labelbreak"></div>
</div>
<div class="break"></div>
</div>
...
<input type="checkbox" name="ContentObjectAttribute_data_media_has_controller_{$attribute.id}" value="{$attribute.content.has_controller}" {section show=$attribute.content.has_controller}checked{/section} />&nbsp;<label class="check">{"Controller"|i18n("content/datatypes/ezmedia")}</label><div class="labelbreak"></div>
...
<div class="element">
<label>{"Controls"|i18n("content/datatypes/ezmedia")}:</label><div class="labelbreak"></div>
...
<div class="block">
<div class="element">
<label>{"Existing filename"|i18n("content/datatypes/ezmedia")}:</label><div class="labelbreak"></div>
<p class="box">{$attribute.content.filename}</p>
</div>
<div class="element">
<label>{"Existing orignal filename"|i18n("content/datatypes/ezmedia")}:</label><div class="labelbreak"></div>
<p class="box">{$attribute.content.original_filename}</p>
</div>
<div class="element">
<label>{"Existing mime/type"|i18n("content/datatypes/ezmedia")}:</label><div class="labelbreak"></div>
<p class="box">{$attribute.content.mime_type}</p>
</div>
<div class="break"></div>
</div>
<div class="buttonblock">
<input class="button" type="submit" name="CustomActionButton[{$attribute.id}_delete_media]" value="{'Delete'|i18n('content/datatypes/ezmedia')}" />
</div>
{/section}

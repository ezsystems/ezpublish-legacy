...
<tr>
	...
	<td class="bglight">
	<input type="password" name="ContentObjectAttribute_data_user_password_{$attribute.id}" size="11" value="">
	</td>
	<td class="bglight">
	{* {$attribute.content.password_hash} *}
	<input type="password" name="ContentObjectAttribute_data_user_password_confirm_{$attribute.id}" size="11" value="">
	</td>
</tr>
</table>

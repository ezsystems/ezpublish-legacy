...
<h1>{"Tool List for Toolbar_%toolbar_position"|i18n("design/standard/design/toolbar",,hash( '%toolbar_position', $toolbar_position ))}</h1>
...
<tr>
    ...
    <th colspan="2">
        {"Tool"|i18n("design/standard/design/toolbar")}
    </th>
    <th>
        {"Placement"|i18n("design/standard/design/toolbar")}
    </th>
</tr>
    ...
    <td>
        ...
        <tr>
            ...
            {case match=1}
                ...
                {/let}
                <br/>
                <input type="submit" name="BrowseButton[{$Tool.index}_parameter_{$Parameter.name}]" value="{"Browse"|i18n("design/standard/design/toolbar")}" />
            ...
            {case match=5}
                ...
                {section show=array( 'true', 'false' )|contains( $Parameter.value )}
                    <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_true" value="true" {section show=$Parameter.value|ne( 'false' )}checked="checked"{/section} /><label for="{$Tool.index}_parameter_{$Parameter.name}_true">{'True'|i18n( 'design/standard/design/toolbar' )}</label>
                    <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_false" value="false" {section show=$Parameter.value|eq( 'false' )}checked="checked"{/section} /><label for="{$Tool.index}_parameter_{$Parameter.name}_false">{'False'|i18n( 'design/standard/design/toolbar' )}</label>
                {section-else}
                  {section show=array( 'yes', 'no' )|contains( $Parameter.value )}
                      <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_true" value="yes" {section show=$Parameter.value|ne( 'no' )}checked="checked"{/section} /><label for="{$Tool.index}_parameter_{$Parameter.name}_true">{'Yes'|i18n( 'design/standard/design/toolbar' )}</label>
                      <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_false" value="no" {section show=$Parameter.value|eq( 'no' )}checked="checked"{/section} /><label for="{$Tool.index}_parameter_{$Parameter.name}_false">{'No'|i18n( 'design/standard/design/toolbar' )}</label>
                  {section-else}
...
<input class="button" type="submit" name="UpdatePlacementButton" value="{'Update Placement'|i18n('design/standard/design/toolbar')}" />
<input class="button" type="submit" name="RemoveButton" value="{'Remove'|i18n('design/standard/design/toolbar')}" />
<input class="button" type="submit" name="StoreButton" value="{'Store'|i18n('design/standard/design/toolbar')}" />
</div>
...
<input class="button" type="submit" name="NewToolButton" value="{'Add Tool'|i18n('design/standard/design/toolbar')}" />

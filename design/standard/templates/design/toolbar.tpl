        ...
        <tr>
            ...
            {case match=5}
                ...
                {if array( 'true', 'false' )|contains( $Parameter.value )}
                    <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_true" value="true" {if $Parameter.value|ne( 'false' )}checked="checked"{/if} /><label for="{$Tool.index}_parameter_{$Parameter.name}_true">{'True'|i18n( 'design/standard/design/toolbar' )}</label>
                    <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_false" value="false" {if $Parameter.value|eq( 'false' )}checked="checked"{/if} /><label for="{$Tool.index}_parameter_{$Parameter.name}_false">{'False'|i18n( 'design/standard/design/toolbar' )}</label>
                {else}
                  {if array( 'yes', 'no' )|contains( $Parameter.value )}
                      <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_true" value="yes" {if $Parameter.value|ne( 'no' )}checked="checked"{/if} /><label for="{$Tool.index}_parameter_{$Parameter.name}_true">{'Yes'|i18n( 'design/standard/design/toolbar' )}</label>
                      <input type="radio" name="{$Tool.index}_parameter_{$Parameter.name}" id="{$Tool.index}_parameter_{$Parameter.name}_false" value="no" {if $Parameter.value|eq( 'no' )}checked="checked"{/if} /><label for="{$Tool.index}_parameter_{$Parameter.name}_false">{'No'|i18n( 'design/standard/design/toolbar' )}</label>
                  {else}

...
{let selected_cache_type=ezpreference( 'admin_clearcache_type' )
     caches_list=array( array( 'All', 'All caches'|i18n( 'design/admin/pagelayout' )|wash, false ),
                        array( 'Content', 'Content'|i18n( 'design/admin/pagelayout' )|wash, false ),
                        array( 'ContentNode', 'Content - node'|i18n( 'design/admin/pagelayout' )|wash, true ),
                        array( 'ContentSubtree', 'Content - subtree'|i18n( 'design/admin/pagelayout' )|wash, true ),
                        array( 'Template', 'Template'|i18n( 'design/admin/pagelayout' )|wash, false ),
                        array( 'TemplateContent', 'Template & content'|i18n( 'design/admin/pagelayout' )|wash, false),
                        array( 'Ini', 'Ini settings'|i18n( 'design/admin/pagelayout' )|wash, false ),
                        array( 'Static', 'Static'|i18n( 'design/admin/pagelayout' )|wash, false ) )}

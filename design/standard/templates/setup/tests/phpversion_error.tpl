...
{section-else}
  ...
  <p>
   ...
   {"You must upgrade to at least version "|i18n("design/standard/setup/tests")}{$required_version}{", but the latest released PHP 4.3.x version is highly recommended."|i18n("design/standard/setup/tests")}
  </p>
{/section}

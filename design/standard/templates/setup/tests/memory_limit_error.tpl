...
<p>{"eZ publish will not work correctly with a memory limit of %1."|i18n("design/standard/setup/tests",,array($current_memory))}</p>
<br/>{"It's highly recommended that you fix this."|i18n("design/standard/setup/tests")}
...
<br/>{"Open the php.ini file and change the memory_limit value to at least %1, and press %2"|i18n("design/standard/setup/tests",,array($required_memory, "Next"|i18n("design/standard/setup/tests")))}

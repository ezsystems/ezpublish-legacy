...
{if count( $file_results.result_elements_by_error_code.2 )}
<h3>{'Missed some directories'|i18n( 'design/standard/setup/tests' )}</h3>
{set-block variable=dir_list scope=root}{foreach $file_results.result_elements_by_error_code.2 as $res}{delimiter} {/delimiter}<i>{$res.file}</i>{/foreach}{/set-block}
...
{set-block variable=dir_list scope=root}{foreach $file_results.result_elements_by_error_code.2 as $res}{delimiter} {/delimiter}{$res.file}{/foreach}{/set-block}
...
{if count( $file_results.result_elements_by_error_code.3 )}
<h3>{'Insufficient directory permissions'|i18n( 'design/standard/setup/tests' )}</h3>

{set-block variable=dir_list scope=root}{foreach $file_results.result_elements_by_error_code.3 as $res}{delimiter} {/delimiter}<i>{$res.file}</i>{/foreach}{/set-block}
...
{set-block variable=dir_list scope=root}{foreach $file_results.result_elements_by_error_code.3 as $res}{delimiter} {/delimiter}{$res.file}{/foreach}{/set-block}
...
{if count( $file_results.result_elements_by_error_code.4 )}
<h3>{'Files instead necessary directories'|i18n( 'design/standard/setup/tests' )}</h3>
{set-block variable=dir_list scope=root}{foreach $file_results.result_elements_by_error_code.4 as $res}{delimiter} {/delimiter}<i>{$res.file}</i>{/foreach}{/set-block}

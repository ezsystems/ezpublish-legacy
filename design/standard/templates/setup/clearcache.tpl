...
{let caches_list=array( array( 'All', 'All caches', false ),
...
<select name="CacheTypeValue">
   ...
   {/section}
    ...
    {/section}
    <input class='button' type=submit name="ClearCacheButton" value="{'Clear'|i18n( 'design/admin/pagelayout' )}">
</form>
{/let}

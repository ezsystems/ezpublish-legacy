...
<p>
{"If you need help with eZ publish, you can go to the"|i18n("design/standard/setup/init")} <a href="http://developer.ez.no">{"eZ publish website"|i18n("design/standard/setup/init")}</a>.
{"If you find a bug (error), please go to"|i18n("design/standard/setup/init")} <a href="http://developer.ez.no/developer/bugreports/">{"eZ publish bug reports"|i18n("design/standard/setup/init")}</a> {"and report it."|i18n("design/standard/setup/init")}

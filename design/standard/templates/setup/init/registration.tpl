...
<tr><td class="normal"><textarea class="box" name="eZSetupRegistrationComment" cols="60" rows="6">{$email_comments}</textarea></td></tr>
</table>
</div>
...
<div align="right">
<input type="checkbox" name="eZSetupSendRegistration" {section show=$send_registration}checked="checked"{/section}value="checked" id="ez_reg_me" /><label for="ez_reg_me">{"Send registration"|i18n("design/standard/setup/init")}</label>
</div>

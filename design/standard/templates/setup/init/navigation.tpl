  <div class="buttonblock" align="right">
    ...
    {section show=eq( $dont_show_back, 1 )|not()}
      <input class="defaultbutton" type="submit" name="eZSetup_back_button" value="&lt;&lt; {"Back"|i18n("design/standard/setup/init", "back button in installation")}" />
    {/section}
    {section show=eq( $refresh, 1 )}
      <input class="defaultbutton" type="submit" name="eZSetup_refresh_button" value="{"Refresh"|i18n("design/standard/setup/init", "Refresh button in installation")}" /> 
    {/section}

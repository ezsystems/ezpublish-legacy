...
<p>
 What kind of language support should this site have.
 The type of support determines the language selection and charset.
</p>
...
<tr>
  <td class="normal">
    Multilingual (multiple languages with one charset)
  </td>
  <td class="normal">

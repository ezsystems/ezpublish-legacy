<div class="warning">
<h2 class="warning">Are you sure you will delete object  {$object.name} from node {$node.object.name}?</h2>
<ul class="warning">
	<li>Delete this assignment  will cause {$ObjectsCount} removed!</li>
</ul>
</div>
...
<h1>Deleting node assignment  of object  {$object.name}  </h1>

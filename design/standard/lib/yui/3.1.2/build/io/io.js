...
}, '3.1.2' ,{requires:['event-custom-base'], optional:['querystring-stringify-simple']});
...
}, '3.1.2' ,{requires:['io-base','datatype-xml']});
...
}, '3.1.2' ,{requires:['io-base','queue-promote']});



YUI.add('io', function(Y){}, '3.1.2' ,{use:['io-base', 'io-form', 'io-xdr', 'io-upload-iframe', 'io-queue']});

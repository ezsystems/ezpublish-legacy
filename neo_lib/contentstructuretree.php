...
class ContentStructureTree
{
    ...
    */
    ...
    public static function getContentStructureTree($rootNodeID, $classFilter = false, $maxDepth = 0, $maxNodes = 0, 
                                                   $sortBy = false, $fetchHidden = false, $unfoldNodeID = 0)
    {
        $sortArray = false;
        if ( $sortBy )
        {
        ...
        return eZContentStructureTreeOperator::contentStructureTree( $rootNodeID,
                                                                               $classFilter,
                                                                               $maxDepth,
                                                                               $maxNodes,
                                                                               $sortBy,

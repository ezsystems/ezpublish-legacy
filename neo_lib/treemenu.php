...
class TreeMenu
{
    ...
    */
    ...
    public static function getTreeMenu( $path, $classFilter = false, $depthSkip = false, $maxLevel = false, $isSelectedMethod = 'tree', 
        $indentationLevel = 15, $language = false)
    {
        $level = 0;
        $done = false;
        $i = 0;
        ...
        while ( !$done && isset( $tmpModulePath[$i+$depthSkip] ) )
        {
                ...
                $level < $maxLevel )
            {
                ...
                if ( !isset( $node ) ) { return $pathArray; }

...
class TopMenu
{
     protected static function getDefaultNames()
     {
        return array(
...
//    }
    /*!
     \reimp
    */
    public static function getTopMenu($context = 'content')
    {
        ...
        foreach ( $tabIDs as $tabID )
        {
            ...
            {
                $dn = self::getDefaultNames();
                $menuItem['name'] = $dn[$tabID]['name'];
            }
            ...
            else
            {
                ...
                $menuItem['tooltip'] = isset( $dn[$tabID]['tooltip'] ) ? $dn[$tabID]['tooltip'] : '';
            }

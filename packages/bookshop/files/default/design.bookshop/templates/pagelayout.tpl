            ...
            <td width="120" valign="top" bgcolor="#ababab">
                ...
                <tr> 
          		...
          		<input class="searchbutton" name="SearchButton" type="image" src={"search.gif"|ezimage} value="Search" />
                	...
                	<br />
            	        <center>
        	        <a href="http://ez.no/"><img src={"powered-by-ezpublish-100x35-grey.gif"|ezimage} alt="eZ publish" border="0" width="100" height="35" /></a>
               	        </center>
                    </td>
                </tr>
                </table>
...
{cache-block}
	        ...
	        <br />
                {let product_list=fetch( content, tree, hash( 
                                         parent_node_id, 2, 
                                         limit, 20, 

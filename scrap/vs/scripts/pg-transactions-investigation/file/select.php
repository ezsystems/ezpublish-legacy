...
$query = "SELECT name FROM file WHERE name_hash='893fb14ac083bd91b5204fe0c4236969'";
#$query  = "SELECT name FROM file WHERE name='var/shop_site/cache/template-block/7/5/7/000099999.cache'";

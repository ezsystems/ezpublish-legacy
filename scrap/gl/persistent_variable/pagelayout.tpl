...
{* Main area START *}
{let persistent_variable=42}

persistent variable 1 {$module_result.content_info.persistent_variable}<br/>
{*persistent variable 1 {$#persistent_variable}<br/>*}
{include uri="design:page_mainarea.tpl"}
persistent variable 2 {$module_result.content_info.persistent_variable}<br/>
{*persistent variable 2 {$#persistent_variable}<br/>*}

<?php
//
// Created on: <22-May-2002 11:09:14 bf>
//
...
$request = new eZSOAPRequest( "echoStruct", $namespace );

$request->addParameter( "inputStruct", array( "varString" => "Hell0 W0rld!",
                                              "varInt" => 42,
                                              "varFloat" => 3.1415 ) );
...
else
{
    ...
    reset( $result );
    while ( list( $key, $child ) = each( $result ) )
    {
        print( "$key  $child <br/>" );
    }
}

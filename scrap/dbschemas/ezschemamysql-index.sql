...
CREATE TABLE ezcollab_item (
	id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	type_identifier varchar(40) NOT NULL ,
	...
	data_float1 float NOT NULL ,
	data_float2 float NOT NULL ,
	data_float3 float NOT NULL ,
	created int(11) NOT NULL ,
	modified int(11) NOT NULL 
);
...
CREATE TABLE ezcontentobject_attribute (
	...
	sort_key_string varchar(50) NOT NULL ,
	data_type_string varchar(50) NOT NULL 
);
...
CREATE TABLE ezpdf_export (
	...
	export_structure varchar(255) ,
	export_classes varchar(255) ,
...
CREATE TABLE ezurl (
	...
	original_url_md5 varchar(32) NOT NULL 
);

...
ALTER TABLE ezcontentobject_link ADD COLUMN contentclassattribute_id integer;
ALTER TABLE ezcontentobject_link ALTER contentclassattribute_id SET NOT NULL;
ALTER TABLE ezcontentobject_link ALTER contentclassattribute_id SET DEFAULT '0';

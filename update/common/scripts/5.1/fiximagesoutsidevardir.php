...
$script = eZScript::instance( array( 'description' => ( "Fixes references to images located outside VarDir.\n\n" .
...
$cli->output( "Searching the database for images that don't start with $varDir");
$rows = $db->arrayQuery( $q = "SELECT * FROM ezimagefile WHERE filepath NOT LIKE '{$varDir}%'" );

     ...
     $Module->isCurrentAction( 'Edit' )*/ )
{
    ...
    $Result['path'] = array( array( 'text' => eZi18n::translate( 'kernel/content', 'Translation' ),
                                    'url' => false ),
                             array( 'text' => 'New',
                                    'url' => false ) );
    return;
...
if ( $Params['TranslationID'] )
{
    ...
    $Result['path'] = array( array( 'text' => eZi18n::translate( 'kernel/content', 'Content translations' ),
...
$Result['path'] = array( array( 'text' => eZi18n::translate( 'kernel/content', 'Languages' ),
                                'url' => false ) );

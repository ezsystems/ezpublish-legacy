...
else if ( $module->isCurrentAction( 'ApplyChanges' ) )
{
    ...
    $error = array( 'code' => 0,
                    'description' => ezpI18n::translate( 'kernel/shop', 'Changes were stored successfully.' ) );
}
...
$Result = array();
$Result['path'] = array( array( 'text' => ezpI18n::translate( 'kernel/shop', 'Available currency list' ),
                                'url' => false ) );

...
if ( strlen( $originalCurrencyCode ) > 0 )
{
    ...
    $pathText = eZi18n::translate( 'kernel/shop', 'Edit currency' );
...
function validateCurrencyData( &$currencyData )
{
    ...
    {
        $return = eZi18n::translate( 'kernel/shop', "'%value' is not a valid custom rate value (positive number expected)",
    ...
    {
        if ( $return === false )
            $return = eZi18n::translate( 'kernel/shop', "'%value' is not a valid rate_factor value (positive number expected)",

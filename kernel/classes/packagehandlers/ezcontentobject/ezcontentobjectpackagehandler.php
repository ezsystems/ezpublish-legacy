    ...
    function explainInstallItem( $package, $installItem, $requestedInfo = array() )
    {
        ...
        if ( $installItem['filename'] )
        {
            ...
            else
            {
                ...
                {
                    return array( 'description' => ezpI18n::translate( 'kernel/package', '%number content objects', false,
            ...
            foreach( $realObjectNodes as $objectNode )
            {
                ...
                $objectNames[] = array( 'description' =>
                                         ezpI18n::translate( 'kernel/package', 'Content object %objectname', false,
                    ...
                    if ( $modified > $published )
                    {
                        ...
                        if ( $choosenAction != eZContentObject::PACKAGE_DELETE )
                        {
                            $installParameters['error'] = array( 'error_code' => eZContentObject::PACKAGE_ERROR_MODIFIED,
                                                                 ...
                                                                 'actions' => array( eZContentObject::PACKAGE_DELETE => ezpI18n::translate( 'kernel/package', 'Remove' ),
                                                                                     eZContentObject::PACKAGE_KEEP => ezpI18n::translate( 'kernel/package', 'Keep object' ) ) );
                            return false;
                        }
                    }
                    ...
                    if ( $childrenCount > 0 )
                    {
                        ...
                        if ( $choosenAction != eZContentObject::PACKAGE_DELETE )
                        {
                            $installParameters['error'] = array( 'error_code' => eZContentObject::PACKAGE_ERROR_HAS_CHILDREN,
                                                                 ...
                                                                 'actions' => array( eZContentObject::PACKAGE_DELETE => ezpI18n::translate( 'kernel/package', "Remove object and its sub-item(s)" ),
                                                                                     eZContentObject::PACKAGE_KEEP => ezpI18n::translate( 'kernel/package', 'Keep object' ) ) );
                            return false;
                        }
                    }

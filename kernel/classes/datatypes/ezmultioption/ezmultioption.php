...
/*!
  ...
  option_id: option_id is unique among all optios, it is used tio retrive values for shop or similar operations.
...
class eZMultiOption
{
    ...
    */
    ...
    /*!
    Sorts the current multioption on the basis of it's priority value. After softing array it calles the function changeMultiOptionID, which again re chante the current priority value to 1,2,3......etc.
    */
    ...
    /*¡
    To find maximum option_id and change the value of OptionCounter with max value.
    */

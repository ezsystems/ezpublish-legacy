...
class eZMultiOption2Type extends eZDataType
{
    ...
    */
    ...
    {
        $this->eZDataType( self::DATA_TYPE_STRING, ezpI18n::translate( 'kernel/classes/datatypes', "Multi-option2", 'Datatype name' ),
    ...
    */
    function validateAddToBasket( $objectAttribute, $data, &$errors )
    {
        ...
        foreach( $data as $moptionID => $selectedItem )
        {
            ...
            {
                $objectAttribute->setValidationError( ezpI18n::translate( 'kernel/classes/datatypes',

...
class eZBinaryFileType extends eZDataType
{
    ...
    {
        $this->eZDataType( self::DATA_TYPE_STRING, ezpI18n::translate( 'kernel/classes/datatypes', "File", 'Datatype name' ),
    ...
    */
                             ...
                             &$result )
    {
        ...
        {
            $result['errors'][] = array( 'description' => ezpI18n::translate( 'kernel/classes/datatypes/ezbinaryfile',

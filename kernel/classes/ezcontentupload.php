...
class eZContentUpload
{
    ...
    */
    function handleLocalFile( &$result, $filePath, $location, $existingNode, $nameString = '' )
    {
        ...
        {
            $result['errors'][] =
                array( 'description' => ezpI18n::translate( 'kernel/content/upload',
        ...
        switch ( $operationResult['status'] )
        {
            case eZModuleOperationInfo::STATUS_HALTED:
            {
                if ( isset( $operationResult['redirect_url'] ) )
                {
                    ...
                    $notices[] = array( 'description' => ezpI18n::translate( 'kernel/content/upload',
            ...
            {
                $result['result'] = ezpI18n::translate( 'kernel/content/upload',
    ...
    */
    function fetchHTTPFile( $httpFileIdentifier, &$errors, &$file, &$mimeData )
    {
        ...
        {
            $errors[] = array( 'description' => ezpI18n::translate( 'kernel/content/upload',

...
<p>
	...
	This collector can be used to make forms.</p>
	
<p>	To make a form that is usable from your site is also quite easy in eZ publish. 
	...
	Add the different attributes you want to have in your form.</p> 
<p>	An example can be the attributes Name, e-mail and What's my problem and we name the form "Contact me". 
...
<p>	<p class="important">Searchable: Searchable means that the content input by the user in the specific attribute is indexed 
	in the search engine.</p>

<p>	<p class="important">Information collector: This is where we make the form. if you check the box for this you will include 
...
<p>	When you now click "Store" you have created the form and added it to the place you want it to be seen. 
	To use the form you now go to "Lists" in the "Content" box. Choose "Form" in the dropdown menu and click 
	"new".</p> 
	
<p>	You now have your form and as soon as you "click "Publish" it is available on your site.  </p>

<p>	The e-mail will be sent to the e-mail that is mentioned in the site.ini file. 
</p>

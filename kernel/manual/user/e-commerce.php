...
you now see an "Add VAT type" button. When clicking this button you will see a "Name" window and a "Percentage" 
...
type before you add any products. We have mentioned how you add classes earlier but we will show it shortly again.</p>
...
<p> Adding products is done by adding "new Vegetables" in the "Content" window. 
...
able to see who bought, what they bought and when they bought. You can alter this list the way you want 
...
<p>
This shopping basket we have put here to test out . In this window you can test out how your shop 
works before you release products. 
</p>
...
<p>
Hvordan skal vi sette opp denne? Tar vi kun med de enkle som blir med i std pakka? 
Og hvor forklarer vi dem i såfall hvor de lager nye funksjoner
</p>

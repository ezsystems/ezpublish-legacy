    ...
    */
    function eZTopMenuOperator( $name = 'topmenu' )
    {
        ...
        $this->DefaultNames = array(
            'content' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                  'Content structure' ),
                                'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                    'Manage the main content structure of the site.' ) ),
            'media' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                'Media library' ),
                              'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                  'Manage images, files, documents, etc.' ) ),
            'users' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                'User accounts' ),
                              'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                  'Manage users, user groups and permission settings.' ) ),
            'shop' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                               'Webshop' ),
                             'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                 'Manage customers, orders, discounts and VAT types; view sales statistics.' ) ),
            'design' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                 'Design' ),
                               'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                   'Manage templates, menus, toolbars and other things related to appearence.' ) ),
            'setup' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                'Setup' ),
                              'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
                                                  'Configure settings and manage advanced functionality.' ) ),
            'dashboard' => array( 'name' => ezpI18n::translate( 'design/admin/pagelayout',
                                                     'Dashboard' ),
                                   'tooltip'=> ezpI18n::translate( 'design/admin/pagelayout',
